  ...
  return new Vuex.Store({
    ...
    actions: {
      ...
      addPost(vuexContext, post) {
        ...
        return this.$axios
        .$post("https://nuxt-blog-80e80.firebaseio.com/posts.json?auth=" + vuexContext.state.token, createdPost)
        .then(data => {
      ...
      editPost(vuexContext, editedPost) {
        return this.$axios.$put("https://nuxt-blog-80e80.firebaseio.com/posts/" +
          editedPost.id +
